...
public class ClosedQueue01_lib {
	...
	private double[] mu;
	private int N, NK, K;
	private double[] alpha, lambda, L, R;
	
	//ネットワーク内の総客数がn人の時のノートk゙でのスループット,平均ノード内客数,平均ノード通過時間(滞在時間)とする

	public ClosedQueue01_lib(double a1, double b1, double c1, double[][] d, double[] p, double[] mu, int n, int k) {
		this.a1 = a1;
		this.b1 = b1;
		this.c1 = c1;
		this.d = d;
